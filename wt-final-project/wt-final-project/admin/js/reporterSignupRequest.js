          ...
          <form action="../controller/verifysignup.php" method="post">
                <div class="grid-container-1">
                    ...
                    <div id="sub-grid">
                            ...
                            <input class="btn-action btn-accept" type="submit" value="approve" name="approve">
                            <input class="btn-action btn-reject" type="submit" value="reject" name="reject">
                    </div>
                </div>
                <div>
                </div>
                ...
                <input type="hidden" name="redirect_path" value="../view/reporterSignupRequest.php">
            </form>
          `;
